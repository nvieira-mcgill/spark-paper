...
\begin{itemize}
    ...
    \item Possibility of NSMs further being the dominant source of the $r$-process in the MW, according to various lines of evidence, e.g. simulations of the hierarchical mergers of dwarf galaxies (\citealt{ishimaru15}), evidence for a single high-yield $r$-process event in ultra-faint dwarf galaxy \ion{Reticulum}{2} (\citealt{ji16, roederer16}),  abundances of $^{244}$Pu in deep-sea reservoirs on Earth (\citealt{wallner15}), and actinide abundances in meteorites (\citealt{bartos19}).
